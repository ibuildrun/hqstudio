...
public static class DbSeeder
{
    ...
    private static void SeedServices(AppDbContext context)
    {
        ...
        context.Services.AddRange(
            new Service { Title = "Доводчики дверей", Category = "Комфорт", Description = "Система автоматических доводчиков позволяет без дополнительных усилий закрывать двери.", Price = "от 15 000 ₽", Icon = "🚪", SortOrder = 1 },
            new Service { Title = "Шумоизоляция", Category = "Тишина", Description = "Профессиональная шумоизоляция автомобиля. Полный комплекс работ.", Price = "от 15 000 ₽", Icon = "🔇", SortOrder = 2 },
            new Service { Title = "Антихром", Category = "Стиль", Description = "Антихром на авто методом качественной обтяжки виниловой пленкой.", Price = "от 4 000 ₽", Icon = "⚫", SortOrder = 3 },
            new Service { Title = "Контурная подсветка", Category = "Атмосфера", Description = "Ambient light — способ выделить свой автомобиль и улучшить атмосферу.", Price = "от 16 000 ₽", Icon = "💡", SortOrder = 4 },
            new Service { Title = "Комплектующие", Category = "Продажа", Description = "Продажа комплектов контурной подсветки Ambient light.", Price = "от 6 000 ₽", Icon = "📦", SortOrder = 5 }
        );
    }
